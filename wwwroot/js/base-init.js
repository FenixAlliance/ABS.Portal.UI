...
(function ($) {
	...
	* ---------------------------*/
    ...
    DASHBOARD.CallToActionAnimation = function () {
    ...
    DASHBOARD.ImgScaleAnimation = function () {
        var controller = new ScrollMagic.Controller();
    ...
    DASHBOARD.SubscribeAnimation = function () {
        var controller = new ScrollMagic.Controller();
    ...
    DASHBOARD.PlanerAnimation = function () {
        var controller = new ScrollMagic.Controller();
    ...
    DASHBOARD.ContactAnimationAnimation = function () {
        var controller = new ScrollMagic.Controller();
    ...
    $document.ready(function () {
        ...
        if ($('.call-to-action-animation').length) {
            DASHBOARD.CallToActionAnimation();
        }

        if ($('.img-scale-animation').length) {
            DASHBOARD.ImgScaleAnimation();
        }

        if ($('.subscribe-animation').length) {
            DASHBOARD.SubscribeAnimation();
        }

        if ($('.planer-animation').length) {
            DASHBOARD.PlanerAnimation();
        }

        if ($('.contact-form-animation').length) {
            DASHBOARD.ContactAnimationAnimation();
        }
...
DASHBOARD.Materialize = function () {
    $.material.init();
...
DASHBOARD.FormValidation = function () {
...
DASHBOARD.IsotopeSort = function () {
...
DASHBOARD.mediaPopups = function () {
...
$(document).ready(function () {
    if (typeof $.fn.magnificPopup !== 'undefined') {
        DASHBOARD.mediaPopups();
    }
});

DASHBOARD.StickySidebar = function () {
    var $header = $('#site-header');

    $('.dashboard-sticky-sidebar').each(function () {
