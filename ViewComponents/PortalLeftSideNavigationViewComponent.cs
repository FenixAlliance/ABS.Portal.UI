...
{
    public class PortalLeftSideNavigationViewComponent : ViewComponent
    {
        private readonly ABMContext _context;
        private IHolderService tools;
        public PortalLeftSideNavigationViewComponent(ABMContext context, IHolderService HolderService)
        {
            _context = context;
            //Add Method Context 
            tools = HolderService;
